    ...
    <div className='border-t-2 pt-20 transition-opacity ease-in duration-500 opacity-100'>
         ...
         <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full  '>
            {
              productData.image.map((item,index)=>(
                <img onClick={()=>setImage(item)} src={item} key={index} className='w-[24%] sm:w-full sm:mb-4 flex-shrink-0 cursor-pointer'  alt="" />
              ))
            }
         </div>
      ...
      <div className='flex-1'>
       ...
       <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
        ...
        <p>Cash on delivery is available on this proudct</p>
      ...
      <div className='mt-20' >
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An ecommerce website is an online store where customers can find products,
             browse offerings, and place purchases online</p>
